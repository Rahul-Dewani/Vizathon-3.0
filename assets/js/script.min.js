          ...
          function k() {
            ...
            m.appendChild(i),
              ...
              a.getComputedStyle &&
                ...
                ((k = j.appendChild(d.createElement("div"))).style.cssText =
                  j.style.cssText =
      ...
      n.extend({
        ...
        ajax: function (b, c) {
          ...
          if (l.beforeSend && (!1 === l.beforeSend.call(m, w, l) || 2 === u))
            return w.abort();
          for (e in ((v = "abort"), { success: 1, error: 1, complete: 1 }))
            w[e](l[e]);
          if ((j = Ub(Pb, l, c, w))) {
    ...
    (function ($) {
      $.fn.initForm = function (options) {
        ...
        jQuery.validator &&
          ...
          this.validate({ rules: { field: { required: !0, email: !0 } } })),
      ...
      window.asyncEach(
        ...
        $(".scrolldown a, .scroll.down").on("click", function () {
          try {
            ...
            $root.animate({ scrollTop: window.innerHeight }, 400, function () {});
          }
        });
